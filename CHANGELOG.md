...
- Improved curation set loading for media boards (kinds 30005/30006): missing referenced `e`-tag media events now load asynchronously through Messenger and trigger a Mercure-driven page refresh once they have been fetched and persisted, instead of blocking the initial page render.
