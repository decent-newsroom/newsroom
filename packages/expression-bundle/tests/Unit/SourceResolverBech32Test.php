...
use DecentNewsroom\ExpressionBundle\Source\SourceResolver;
...
class SourceResolverBech32Test extends TestCase
{
    private function callDecodeBech32Input(array $inputRef): array
    {
        ...
        $bech32Prop = (new \ReflectionClass(SourceResolver::class))->getProperty('bech32Encoder');
        $bech32Prop->setValue($resolver, new Bech32EncoderAdapter());
