...
use DecentNewsroom\ExpressionBundle\Service\FeedCacheService;
...
class FeedCacheServiceTest extends TestCase
{
    ...
    public function testBuildKeyDiffersWhenExpressionRepublished(): void
    {
        ...
        $original = $this->makeEvent('expr1', 30880, 1_700_000_000);
        $edited = $this->makeEvent('expr1', 30880, 1_700_000_500);
    ...
    private function makeEvent(string $id, int $kind, ?int $createdAt = null): ArrayEvent
    {
