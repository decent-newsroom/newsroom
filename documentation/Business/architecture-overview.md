...
│  ✓ Can publish DN_SCOPE_DEF (create subscription scopes)                    │
...
│  ✓ View subscriber list (from DN_SCOPE_MEMBERSHIP_GRANT events)             │
...
│ Preview/Teaser     │ PUBLIC               │ + DN_SCOPE_MEMBERSHIP_GRANT   │
│ Full Article       │ GATED                │                               │
├────────────────────┼──────────────────────┼───────────────────────────────┤
│ Publication        │ SCOPE ENTITLEMENT    │ Pay scope owner               │
│ (all articles)     │ GATED                │ + DN_SCOPE_MEMBERSHIP_GRANT   │
├────────────────────┼──────────────────────┼───────────────────────────────┤
│ Author npub        │ SCOPE ENTITLEMENT    │ Pay scope owner               │
│ (all content)      │ GATED                │ + DN_SCOPE_MEMBERSHIP_GRANT   │
├────────────────────┼──────────────────────┼───────────────────────────────┤
│ Publishing Rights  │ PUBLISHER GRANT      │ Pay relay operator            │
│ (write to relay)   │ GATED                │ + DN_RELAY_PUBLISH_GRANT      │
├────────────────────┼──────────────────────┼───────────────────────────────┤
...
- Gets DN_SCOPE_MEMBERSHIP_GRANT
- **Pays: fee to author**
