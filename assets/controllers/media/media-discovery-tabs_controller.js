...
/**
 * Controller for managing media discovery tabs with Turbo Frame loading.
 *
...
export default class extends Controller {
    ...
    async switchTab(event) {
        ...
        if (clickedTab.getAttribute('aria-disabled') === 'true') return;
        ...
        const targetFrame = this.contentTarget.querySelector('turbo-frame#media-tab-content');
        if (targetFrame) {
        ...
        try {
            ...
            const frameContent = doc.querySelector('turbo-frame#media-tab-content');
            ...
            console.error('[media-tabs] Error fetching tab content:', error);
     ...
     */
    _loadingHTML() {
        return `<div class="media-discovery__loading">
